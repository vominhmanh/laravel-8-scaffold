        ...
        <div class="card-body d-flex flex-column justify-content-between">
            <div class="course-card-top d-flex flex-row">
                ...
                <div class="course-card-top-content w-100">
                    <a href="{{ route('course.detail', [$course->id]) }}" class="course-card-top-content-title">{{ $course->name }}</a>
                    <div><b>Teacher: {{ $course->teacher->name }}</b> </div>
                    <div class="course-card-top-content-description">{{ $course->description }}</div>
                    <div class="text-right">
                        <a href="{{ route('course.detail', [$course->id]) }}" class="green-btn hover-green-btn small-inset-shadow detail-link-a">More</a>
                    </div>
                </div>
            </div>
